      ...
      <div className="max-w-md w-full">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-gray-600">
            {isLogin 
              ? 'Sign in to protect your career opportunities'
              : 'Join us to stay safe from internship scams'
            }
          </p>
        </div>
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className={`input-field pl-10 ${errors.fullName ? 'border-danger-500' : ''}`}
            ...
            {!isLogin && (
              <div>
                ...
                <input
                  ...
                  onChange={handleInputChange}
                  className={`input-field ${errors.university ? 'border-danger-500' : ''}`}
